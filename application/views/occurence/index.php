...
<div class="breadcrumb-header justify-content-between">
	...
	<div class="d-flex my-xl-auto right-content">
		...
		<div class="pr-1 mb-3 mb-xl-0">
			<a href="<?= base_url('occurence/add') ?>" type="button" class="btn btn-primary  mr-2">Tambah Data</a>
		</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">
									...
									<tbody>
										<?php
										foreach ($occurence as $e) { ?>
											<tr>
												<td><?= strtoupper($e->occurence_type) ?></td>
												<td><?= strtoupper($e->probability_of_damage) ?></td>
												...
												<td>
													...
													<a href="#" onclick="deleteConfirm('<?= 'occurence/remove/' . $e->id_master_occurence ?>')">Delete </a>
												</td>
											</tr>
										<?php } ?>
									</tbody>
