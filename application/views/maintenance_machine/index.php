						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select id='fmea_type' class="form-control <?= form_error('fmea_type') ? 'is-invalid' : '' ?>" name="fmea_type">
									<option value="" selected hidden>Choose FMEA Type</option>
									<option value="none">None</option>
									<option value="priority machine">Priority Machine (Mesin Prioritas)</option>
									<option value="qualification standard Machine">Qualification Standard Machine (Mesin Standar Kualifikasi)</option>
								</select>
