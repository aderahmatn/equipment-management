...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Report Transaction Main Process</h4>
        </div>
    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id='id_master_main_process' class="form-control <?= form_error('id_master_main_process') ? 'is-invalid' : '' ?>" name="id_master_main_process">
                                    <option value="" selected hidden>Choose main process</option>
                                    <?php foreach ($main_process as $key) : ?>
                                        <option value="<?= $key->id_master_main_process ?>"><?= strtoupper($key->main_process) ?></option>
                                    <?php endforeach ?>
                                </select>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('pdf/report_main_process/') . $mp ?>" class="btn btn-primary" target="_blank">PDF</a>
                </div>
                <div class="card-body">
