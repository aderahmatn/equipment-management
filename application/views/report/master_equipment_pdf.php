...
$pdf->AddPage();
$pdf->SetTitle("Report Master Equipment", 1);
...
$pdf->Cell(275, 7, 'REPORT MASTER EQUIPMENT ', 0, 1, 'C');
// Memberikan space kebawah agar tidak terlalu rapat
$pdf->Cell(10, 7, '', 0, 1);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(10, 6, 'No', 1, 0, 'C');
$pdf->Cell(50, 6, 'MACHINE CODE', 1, 0, 'C');
$pdf->Cell(60, 6, 'EQUIPMENT NAME', 1, 0, 'C');
$pdf->Cell(50, 6, 'PURCHASE DATE', 1, 0, 'C');
$pdf->Cell(40, 6, 'LINE', 1, 0, 'C');
...
foreach ($equipment as $key) {
    $pdf->Cell(10, 6, $no++ . '.', 1, 0, 'C');
    $pdf->Cell(50, 6, strtoupper($key->machine_code), 1, 0);
    $pdf->Cell(60, 6, strtoupper($key->equipment_name), 1, 0);
    $pdf->Cell(50, 6, strtoupper($key->machine_purchase_date), 1, 0);
    $pdf->Cell(40, 6, strtoupper($key->line), 1, 0);
    $pdf->Cell(50, 6,  strtoupper($key->machine_enter_line), 1, 0);
    $pdf->Cell(20, 6, strtoupper($key->qty), 1, 1);
}
