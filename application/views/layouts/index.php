    ...
    <div class="page">
        ...
        <aside class="app-sidebar sidebar-scroll">
            ...
            <div class="main-sidemenu">
                ...
                <?php if ($this->session->userdata('division') == 'manager') { ?>
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item <?= $this->uri->segment(1) == 'transaction_main_process' ? 'active' : '' ?><?= $this->uri->segment(1) == 'maintenance_machine' ? 'active' : '' ?><?= $this->uri->segment(1) == 'maintenance_machine_result' ? 'active' : '' ?><?= $this->uri->segment(1) == 'machine_shrinkage' ? 'active' : '' ?>" data-toggle="slide" href="#">
                ...
                <!-- SIDEBAR MENU ADMIN-->
                <?php if ($this->session->userdata('division') == 'admin') { ?>
                    <ul class="side-menu">
                        <li class="slide <?= $this->uri->segment(1) == 'dashboard' ? 'active' : '' ?><?= $this->uri->segment(1) == '' ? 'active' : '' ?>">
                            <a class="side-menu__item" href="<?= base_url('dashboard') ?>"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0V0z" fill="none"></path>
                ...
                <!-- SIDEBAR MENU USER-->
                <?php if ($this->session->userdata('division') == 'user') { ?>
                    <ul class="side-menu">
                        <li class="slide <?= $this->uri->segment(1) == 'dashboard' ? 'active' : '' ?><?= $this->uri->segment(1) == '' ? 'active' : '' ?>">
                            <a class="side-menu__item" href="<?= base_url('dashboard') ?>"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0V0z" fill="none"></path>
                ...
                <!-- SIDEBAR MENU TECHNICIAN-->
                <?php if ($this->session->userdata('division') == 'technician') { ?>
                    <ul class="side-menu">
                        <li class="slide <?= $this->uri->segment(1) == 'dashboard' ? 'active' : '' ?><?= $this->uri->segment(1) == '' ? 'active' : '' ?>">
                            <a class="side-menu__item" href="<?= base_url('dashboard') ?>"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0V0z" fill="none"></path>
